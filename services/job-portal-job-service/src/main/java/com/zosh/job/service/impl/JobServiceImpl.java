...
public class JobServiceImpl implements JobService {
    ...
    public JobResponse createJob(Long employerId, JobRequest request) throws Exception {
        ...
        Set<JobSkill> skills = request.getSkillIds() != null ? skillService.getSkillByIds(request.getSkillIds())
                : Collections.emptySet();

        Set<JobTag> tags = request.getTagIds() != null ? tagService.getTagsByIds(request.getTagIds())
                :Collections.emptySet();
